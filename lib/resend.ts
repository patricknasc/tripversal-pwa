...
<head>
  ...
  <title>Join ${tripName} on Tripversal</title>
</head>
<body style="margin:0;padding:0;background:#0a0a0a;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:480px;margin:0 auto;padding:40px 24px;">
    <div style="color:#00e5ff;font-size:22px;font-weight:900;letter-spacing:4px;margin-bottom:8px;">TRIPVERSAL</div>
    ...
    <div style="background:#141414;border-radius:20px;padding:32px;border:1px solid #2a2a2e;">
      ...
      <p style="color:#8e8e93;font-size:15px;line-height:1.6;margin:0 0 24px;">
        ...
        <strong style="color:#00e5ff;">${tripName}</strong> on Tripversal.
      </p>
    ...
    <div style="color:#3a3a3c;font-size:11px;text-align:center;margin-top:24px;">
      Tripversal · Your travel companion
    </div>
  </div>
</body>
</html>`;
